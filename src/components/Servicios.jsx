const Servicios = () => {
  return (
    <div>
      <div>
        <p className='font-bold xl:text-4xl py-10 xl:text-center xl:tracking-widest sm:text-5xl text-4xl ml-5 xl:ml-0'>
          Nuestros servicios
        </p>
      </div>
      <div className='flex flex-col xl:flex-row xl:gap-10 md:gap-5 gap-10 rounded-[10px] justify-center items-center mx-[10%] mb-20'>
        <div className='relative'>
          <img className='p-3 pb-0 bg-[#E7E4E4] xl:h-[300px] md:h-[550px] h-[70%] xl:w-[600px] w-full ' src='/otras/77665eeb-9129-447b-ab4c-359a21168402.jpg' />
