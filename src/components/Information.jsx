    ...
    <div className=' w-full'>
      ...
      <div className='fixed w-[60px] h-[60px] bg-[#25d366] bottom-10 right-[20px] text-[#fff] rounded-[50%] text-center shadow-[2px_2px_3px_#999] z-50 hover:bg-[#28e56d] '>
        ...
        >
          ...
          <span className=' font-FiraSans fixed right-[90px] bottom-[52px] bg-white text-black p-1.5 rounded-lg font-semibold tracking-wider'>Asesoría Personalizada</span>
        </a>
      </div>
      <section>
      ...
      <section>
        ...
        <div className='grid gap-1 items-center justify-center xl:px-60 p-10 pb-20'>
          <div className='grid grid-cols-3 gap-1'>
            <img className='h-full' src='/Centro-de-estudio/b7f3a914-052f-4e09-a4c8-d6eb3ac63423.jpg' />

            <img className='row-span-2 col-start-2 col-end-5 h-full justify-center' src='/Centros-de-entretenimiento/48f635be-97a5-431e-95dc-2cac08fe8dd3.jpg' />
            <img className='h-full' src='/Centro-de-estudio/c35cd6c0-57af-4a90-b8ae-c26bc675415c.jpg' />
